...
//		FhirResourceManagerDstu2 loader = CodeGeneratorConfigurator.buildFhirResourceManager(configurator, true);
		...
		try {
			...
			assertEquals(org.hl7.fhir.dstu3.model.Address.class.getName(), hapiAddressType);
		} catch(Exception e) {
			e.printStackTrace();
...
//			assertEquals(org.hl7.fhir.dstu3.model.Medication.Product.class.getName(), hapiMedProductType);
//		} catch(Exception e) {
//			e.printStackTrace();
