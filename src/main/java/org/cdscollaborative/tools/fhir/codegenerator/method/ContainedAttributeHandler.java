...
public class ContainedAttributeHandler extends BaseMethodGenerator {
	...
	public ContainedAttributeHandler(FhirResourceManager manager, CodeTemplateUtils template, StructureDefinition profile, ElementDefinitionDt element) {
	...
	public List<Method> buildCorrespondingMethods() {
		...
		methods.add(constructSetMethod(getFullyQualifiedType()).setBody(buildDelegatedSetterBody(getTopLevelCoreAttribute())));
		return methods;
	}
